...
%USERPROFILE%\Downloads\cygwin-setup.exe -qvg -P tcl -P expect -P git -P gcc-g++ -P make -P astyle -P diffutils -P libmpfr-devel -P libgmp-devel -P libmpc-devel -P cmake -P gdb
